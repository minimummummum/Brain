        ...
        while True:
            ...
            if sw == 1:
                ...
                if index_end != -1:
                    ...
                    # OpenCV: Read image from byte array
                    img = cv2.imdecode(nparr, cv2.IMREAD_COLOR)
                    
                    # OpenCV: Display the image
                    try:
                        cv2.imshow('Stream', img)
                        if -10 <= receive_sensor[2] <= 10:
                            #cv2.imshow('Front', img)
                            pass
                        if 80 <= receive_sensor[2] <= 100 or -260 >= receive_sensor[2] >= -280:
                            #cv2.imshow('Right', img)
                            pass
                        if 170 <= receive_sensor[2] <= 190 or -170 >= receive_sensor[2] >= -190:
                            #cv2.imshow('Back', img)
                            pass
                        if 260 <= receive_sensor[2] <= 280 or-80 >= receive_sensor[2] >= -100:
                            #cv2.imshow('Left', img) 
                            pass
